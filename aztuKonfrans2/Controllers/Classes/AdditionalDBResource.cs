...
namespace aztuKonfrans2.Classes
{
    public class AdditionalDBResource
    {
        public static string[] degree
        {
            get
            {
                return new string[] { Resource.degree_1, Resource.degree_2 };
            }
        }
        ...
        public static string[] country_tr
        {
            get
            {
                string s = "Akrotiri ve Dekeliya,Aland Adaları,Arnavutluk,Almanya,Amerikan Samoası,Andorra,Anguilla,Angola,Antigua ve Barbuda,Arjantin,Aruba,Avustralya,Avusturya,Azerbaycan,Bahamalar,Bangladeş,Barbados,Belçika,Belize,Belarus,Benin,Bermuda Adaları,Birleşik Arap Emirlikleri,Bolivya,Bulgaristan,Bosna Hersek,Botsvana,Büyük Britanya,Brezilya,Brunei,Burkina-Faso,Burundi,Butan,Bahreyn,Jersey,Cebelitarık,Güney Afrika Cumhuriyeti,Güney Sudan,Güney Kore,Cibuti,Çad,Çek Cumhuriyeti,Karadağ,Şili,Çin,Danimarka,Dominika,Dominik Cumhuriyeti,Etiyopya,Ekvador,Ekvator Ginesi,Eritre,Estonya,Afganistan,Cezayir,Farer Adaları,Filistin,Fici,Fildişi Sahili,Filipinler,Finlandiya,Folklend Adaları,Fransa,Fransız Polinezyası,Gernsi,Gürcistan,Haiti,Hindistan,Honduras,Hong Kong,Hırvatistan,Endonezya,Ürdün,Irak,İran,İrlanda,İzlanda,İspanya,İsrail,İsveç,İsviçre,İtalya,Cape Verde,Kamboçya,Kamerun,Kanada ,Cayman Adaları,Kenya,Güney Kıbrıs Rum Kesimi,Kiribati,Cocos Adaları,Kolombiya,Komor Adaları,Kongo Cumhuriyeti,Demokratik Kongo Cumhuriyeti,Kosova,Kosta Rika,Küba,Cook Adaları,Kuveyt,Gabon,Gambiya,Gana,Katar,Guyana,Kazakistan,Batı Sahra,Kırgızistan,Tahıl,Grönland,Guam,Guatemala,Gine,Gine-Bissau,Laos,Letonya,Lesoto,Liberya,Litvanya,Lübnan,Libya,Lihtenştayn,Lüksemburg,Macaristan,Madagaskar,Amerika Papağanı,Kuzey Makedonya,Malavi,Malezya,Maldivler,Mali,Malta,Marshall Adaları,Mauritius,Moritanya,Mayotta,Meksika,Man Adaları,Fas,Orta Afrika Cumhuriyeti,Mikronezya,Noel Adaları,Mısır,Myanmar,Moldova,Monako,Moğolistan,Monserat,Mozambik,Saint Helena,Yükseliş ve Tristan da Cunha,Namibya,Nauru,Nepal,Hollanda,Hollanda Antilleri,Nijer,Nijerya,Nikaragua,Niue,Norfolk Adaları,Norveç,Umman ,Özbekistan,Pakistan,Palau,Panama,Papua Yeni Gine,Paraguay,Peru,Pitcairn Adaları,Polonya,Portekiz,Prednestroviya,Porto Riko,Ruanda,Romanya,Rusya,Salvador,Samoa,San-Marino,São Tomé ve Príncipe,Senegal ,Saintjacques-Barthelemy,Saint Kitts ve Nevis,Gönderilmiş Lucia,Saint Martin,Saint Pierre ve Miquelon Koleksiyonu,Saint Vincent ve Grenadinler,Se rbia,Seyşeller,Suudi Arabistan,Singapur,Slovakya,Slovenya,Solomon Adaları,Somali,Somalilend,Sudan,Surinam,Suriye,Esvatini,Sierra Leone,Doğu Timor,Kuzey Kore,Kuzey Marian Adaları,Spitsbergen,Sri Lanka,Tacikistan,Tanzanya,Tayland,Taivan - Çin Cumhuriyeti,Turks ve Caicos Adaları,Tokelau,Tonga,Togo,Trinidad ve Tobago,Tunus,Tuvalu,Türkiye,Türkmenistan,Ukrayna,Wallis ve Futuna Adaları,Uganda,Uruguay,Vanuatu,Vatikan,Venezuela,Amerika Birleşik Devletleri Virgin Adaları,İngiliz Virgin Adaları,Vietnam,Jamaika,Japonya,Yeni Kaledonya,Yeni Zelanda,Yemen,Yunanistan,Zambiya,Zimbabve ";
                string[] countries = s.Split(',');
                return countries;
            }
        }
